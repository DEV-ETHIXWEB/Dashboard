                        ...
                        <div className="flex w-1/2 shrink-0 flex-col gap-5" inert={!forgotOpen}>
                          ...
                          {forgotSent ? (
                            ...
                            <form onSubmit={requestReset} className="flex flex-col gap-3.5">
                              ...
                              {/* Without this the request can fail and the panel
                                  just sits there, which is the same silence the
                                  sent-state fix was meant to end. */}
                              {forgotError && (
                                <div
                                  role="alert"
                                  className="rounded-md border border-destructive/20 bg-destructive/10 px-3.5 py-2.5 text-xs font-medium text-destructive"
                                >
                                  {forgotError}
                                </div>
                              )}
